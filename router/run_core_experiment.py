"""
Core experiment: compares all 7 routing strategies (Always Fast, Always Heavy,
Round Robin, Rule-Based, ML Router, Single-Shot Router, CorrectnessGateNet
Router) on ACCURACY using the held-out image set.
